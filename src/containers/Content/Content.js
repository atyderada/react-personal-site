                ...
                <Container>
                        ...
                        <WhenInView>
                            {({ isInView }) =>
                                <RevealText hide={!isInView}>
                                    ...
                                    work, photograpy, travel, fitness and music. I built this site to share these things with you !
                                </RevealText>
                            }
                        </WhenInView>
                        ...
                        <WhenInView>
                            {({ isInView }) =>
                                <RevealText hide={!isInView}>
                                    ...
                                    developing and improving websites with top of the line technologies. I used React, Three.js, and
                    ...
                    <SectionContainer id="travel">
                        ...
                        <WhenInView>
                            {({ isInView }) =>
                                <RevealText hide={!isInView}>
                                  I love traveling and visiting new countries !! Check out the map bellow with the countries that I have visited !
                                </RevealText>
                            }
                        </WhenInView>
