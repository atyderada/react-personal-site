...
export default class Scene extends Component {
  ...
  componentDidMount() {
    ...
    const camera = new THREE.PerspectiveCamera(
      70, // vertical field of view (angle)
      width / height, // ratio
      15, // near plane (z distance)
      10000 // far plane (z distance)
    )
    ...
    var material = new THREE.PointsMaterial( { size: 2.2, sizeAttenuation: false, alphaTest: 0.5, transparent: true } );
